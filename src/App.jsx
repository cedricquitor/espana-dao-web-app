...
const App = () => {
  ...
  const editionDrop = useEditionDrop("0xf294fD804a019Bb0ff9AF188FC01BaEa14D3ec87");
  // Initialize our governance token
  const token = useToken("0x8a0E74f555331C5a91D5b13B1AD5ca578487d1B4");
  // Initialize our governance contract
  const vote = useVote("0x60eb377C15Fafc17bc55731f1891BB87b16e6aBC");
  ...
  return (
    <div className="mint-nft">
      <h1>Mint your free 🐅EspañaDAO Membership NFT</h1>
